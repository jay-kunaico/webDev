...
//* A look back on classes Classes are both types and values = declaration merging
...
class Fruit2 {
  ...
  color?: string
  static createBanana() {
    return { name: 'banana', color: 'yellow', mass: 183 } // as const here to make it readonly
  }
}
// how to test for a value
const valueTest = Fruit2 // Fruit is a value! a class is a value
valueTest.createBanana

// how to test for a type
let typeTest: Fruit2 = {} as any // Fruit is a type! a class is a type
typeTest.color
