...
type GetFirstArg<T extends OneArgFn> = T extends OneArgFn<infer R>
  ? R
  : never
...
type GetFirstArg2<T> = T extends OneArgFn<infer R> ? R : never
 ...
 */
type _ThisParameterType<T> = T extends (
  this: infer U,
  ...args: never
) => any
  ? U
