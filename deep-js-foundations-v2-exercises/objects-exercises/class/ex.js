// parent class that composes methods for inheritance
class Helpers {
...
// take advantage of "extends" that inherits helpers
// class that holds methods instead of object
class Workshop extends Helpers {
  // define a constructor instead of properties
  constructor() {
    super();
  ...
  printRecords(recordIds) {
    ...
    // inherited by parent class Helpers that was extended
...
// instantiate it  We need new because of the constructor
